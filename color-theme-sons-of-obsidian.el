...
(defun color-theme-sons-of-obsidian ()
  ...
  (color-theme-install
   '(color-theme-sons-of-obsidian
     ...
     (font-lock-builtin-face ((t (:foreground "#8C8CB4"))))
     (font-lock-constant-face ((t (:foreground "#ffc0ff"))))
     (font-lock-comment-face ((t (:foreground "#66747B"))))
     ...
     (font-lock-type-face ((t (:foreground "#7ab847"))))
     ...
     (highlight ((t (:background "#afc8e4" :foreground "grey10"))))
